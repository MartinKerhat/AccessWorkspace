...
type Authenticator interface {
	...
	SetupVaultWithPasskey(ctx context.Context, user User, token, credentialID, prfSalt, prfSecret, nickname string) error
	UnlockVaultWithPasskey(ctx context.Context, user User, token, credentialID, prfSecret string) error
	AddVaultPasskey(ctx context.Context, user User, credentialID, prfSalt, prfSecret, nickname string) error
	RemoveVaultMethod(ctx context.Context, user User, method, label string) error
	RenameVaultPasskey(ctx context.Context, user User, credentialID, nickname string) error
	LockVault(ctx context.Context, token string) error
